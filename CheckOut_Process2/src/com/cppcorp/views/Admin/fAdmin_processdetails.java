 ...
 * @author grbg
 */
public class fAdmin_processdetails extends javax.swing.JFrame {
    ...
    private void btnAdduserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdduserActionPerformed
        try {
            viewController.fautp = new fAddUsertoProcess();
            viewController.fautp.setVisible(true);
            
            viewController.fautp.process = process;
            viewController.fautp.loadAllUsers();
            
            this.setVisible(false);
        } catch (SQLException ex) {
            Logger.getLogger(fAdmin_processdetails.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fAdmin_processdetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fAdmin_processdetails().setVisible(true);
            }
        });
    }
